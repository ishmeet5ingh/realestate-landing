  ...
  return (
    <section className="w-full bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        {/* Grid */}
        <div className="mt-12 sm:mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-10">
          {items.map(({ no, title, desc, Icon }) => (
            <div key={no} className="flex items-start gap-5">
              {/* icon badge */}
              <div className="shrink-0">
                <div className="h-32 w-32 rounded-full bg-gray-50 shadow-md flex items-center justify-center">
                <Icon className="h-16 w-16 text-red-400" aria-hidden="true" />
                </div>
              </div>
