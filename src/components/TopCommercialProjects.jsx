        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 sm:gap-6 px-4 sm:px-6 ">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-black/5 border border-black/10 rounded-full px-3 py-1.5 text-[11px] sm:text-xs">
              ...
              <span className="tracking-wide text-black/80">
                COMMERCIAL PICKS
              </span>
            </div>
            ...
            <p className="mt-2 text-sm sm:text-base text-black/70 max-w-xl">
              Office, retail and mixed-use assets designed for strong
              visibility, access and long-term demand.
            </p>
          </div>
            ...
            {projects.map((_, i) => (
              <button
                ...
                onClick={() => {
                  const el = scrollerRef.current;
                  if (el)
                    el.scrollTo({ left: i * CARD_WIDTH, behavior: "smooth" });
                }}
